...
const NAV: Record<string, NavGroup[]> = {
  ...
  MANAGER: [
    ...
    { title: 'Administration', items: [
      ...
      { label: 'Rapports',      href: '/manager/rapports',      icon: I.download },
  ...
  SUPERADMIN: [
    ...
    { title: 'Clients', items: [
      ...
      { label: 'Abonnements',       href: '/admin/abonnements',     icon: I.card     },
      { label: 'Utilisateurs',      href: '/admin/utilisateurs',    icon: I.users    },
    ]},
    { title: 'Système', items: [
      { label: 'Journal',           href: '/admin/journal',         icon: I.book     },
      { label: 'Paramètres',        href: '/admin/parametres',      icon: I.cog      },
    ]},
  ],
}
