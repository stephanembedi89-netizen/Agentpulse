    ...
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <StatCard label="Mes prospects" value="—" color="bg-blue-600" />
          <StatCard label="Polices actives" value="—" color="bg-emerald-600" />
          <StatCard label="Commissions du mois" value="—" color="bg-violet-600" />
        </div>
      </div>
    </div>
  )
